 ...
 */
edu.rpi.tw.sesf.s2s.widgets.DCOPubBooleanSelect = function(panel) 
{
    this.panel = panel;
...
edu.rpi.tw.sesf.s2s.widgets.DCOPubBooleanSelect.prototype.updateState = function(clicked)
{
...
edu.rpi.tw.sesf.s2s.widgets.DCOPubBooleanSelect.prototype.getState = function()
{
    return this.state;
}

edu.rpi.tw.sesf.s2s.widgets.DCOPubBooleanSelect.prototype.setState = function(state)
{
    var self = this;
...
edu.rpi.tw.sesf.s2s.widgets.DCOPubBooleanSelect.prototype.get = function()
{
    return this.div;
}

edu.rpi.tw.sesf.s2s.widgets.DCOPubBooleanSelect.prototype.reset = function()
{
...
/*
edu.rpi.tw.sesf.s2s.widgets.DCOPubBooleanSelect.prototype.update = function(data)
{
