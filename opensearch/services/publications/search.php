...
if (@$_GET['keywords'] && @$_GET['keywords'] != '') {
    $constraints['keywords'] = explode(";",$_GET['keywords']);
}
...
// Get the the DCO author constraints from the request url
...
// Get the concept constraints from the request url
if (@$_GET['concepts'] && @$_GET['concepts'] != '') {
    $constraints['concepts'] = explode(";",$_GET['concepts']);
}
...
// instantiate the Config class for the publication browser (class
// definition in "publications.php")
$s2s = new DCO_Publications_S2SConfig();
